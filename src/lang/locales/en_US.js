...
module.exports = {
  ...
  "widget.hovereffect": "HOVER EFFECT",
  ...
  "lp.featurecarousel.detail-1":
    "User experience principles at the heart of the design process.",
  ...
  "lp.featurecarousel.detail-3":
    "A two part menu that looks good and does the job well.",
  "lp.featurecarousel.title-4": "Layouts for the Job",
  "lp.featurecarousel.detail-4":
    "Lots of different layouts for different tasks.",
  "lp.featurecarousel.title-5": "Extra Responsive",
  "lp.featurecarousel.detail-5":
    "Better experiences for small and large screens via xxl and xxs.",
  ...
  "lp.icons.detail-2":
    "Carefully themed video player powered by Video.js library with Youtube support.",
  ...
  "lp.register.detail-1":
    "Please use this form to register. If you are already a member, please",
  "lp.register.login": "login",
  "lp.register.buttonlabel": "REGISTER",

  "lp.docs.title": "Answers from Our Team",
  "lp.docs.detail":
    "Search our documentation, guides and frequently asked questions.",
  "lp.docs.search": "Search",

  "lp.videos.title": "Video Guides",
  "lp.videos.detail":
    "Search our videos to provide you the guidence to get you started.",
  ...
  "lp.content.detail":
    "Green space global, policymaker; shared value disrupt segmentation social capital.",
  ...
  "lp.confirmation.detail-2":
    "You can start using Gogo or might want to check out",
